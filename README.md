...
The project was completed collaboratively by Group 16.

High-level contribution areas included:
...
- baseline modelling
- BioBERT embedding experiments
- BioBERT fine-tuning
- PubMedBERT fine-tuning
- classical Axis 2 models
- advanced transformer experiments
- maybe-class interventions
- threshold tuning
- focal loss experiments
- ordinal-aware loss
- hierarchical classification
...
- prediction export
- report writing
- LaTeX/Overleaf management
- GitHub repository organisation

Tanishk Nanasaheb Shinde contributed to advanced transformer and maybe-class modelling, final integration, result tables, graphs, notebook cleanup, GitHub maintenance, and report source management.

---

## Academic Integrity Statement

This repository is submitted as coursework for the University of Bristol module:

```text
EMATM0067 – Introduction to AI and Text Analytics
```

The contents are intended for academic assessment, reproducibility, and demonstration of the group’s experimental process.

---

## Citation

If referencing this repository, please cite it as:

```text
Shinde, T. N., Alahmari, A., Wang, P., Xue, Z., and Kashyap, A.
Medical Question Answering on PubMedQA: Analysing Text Representations and Classifier Design.
EMATM0067 – Introduction to AI and Text Analytics, University of Bristol, Group 16.
```
...
This repository is for educational and coursework purposes only.  
